...
def parse_args():
    ...
    parser.add_argument('--model', help="path to model", type=str, default="./result_version_conv/131_epoc.pt")
    parser.add_argument('-i', '--input', help="path to input files", type=str, default="./data/test/test_info.csv")
    parser.add_argument('-o', '--output', help="path to output files", type=str, default="output_f.txt")
