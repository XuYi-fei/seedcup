...
from XXNet_model import CTNetPlus
...
def parse_args():
    ...
    parser.add_argument('--model', help="path to model",
                        type=str, default="../../checkpoints/XXNet/146_epoc_loss_0.5038768845214955_fscore_0.8025766085680138.pt")
    parser.add_argument('-i', '--input', help="path to input files",
                        type=str, default="../../data/33_dimension/test_b.csv")
    parser.add_argument(
        '-o', '--output', help="path to output files", type=str, default="XX_output_0.8257.txt")
